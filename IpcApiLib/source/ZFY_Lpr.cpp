...
extern "C" BOOL ZFY_LprProcessEx(char *ModelPath,char *ImgPath,PCODE_LIST pCodeList) 
{
    char *model_path = ModelPath;//"/opt/resource/models/r2_mobile";
    ...
    data.format = STREAM_RGB;                  // 设置当前图像编码格式
    ...
    configuration.nms_threshold = 0.15f;             // 非极大值抑制置信度阈值
    configuration.rec_confidence_threshold = 0.15f;  // 车牌号文本阈值
    configuration.box_conf_threshold = 0.03f;       // 检测器阈值
