...
{  
	...
	//time(&stop_time);
	//ZFY_IpcStopRecord(0);
	//ZFY_IpcSnapShot("123",0);
	//sleep(5);
	//ZFY_IpcLoadRecord(start_time,stop_time,0);
	memset(&code_list,0,sizeof(code_list));
	ZFY_LprProcess("/opt/resource/images/test_img.jpg",&code_list);
	
	for(i=0;i<code_list.CodeNum;i++)
		printf("-----code=%s-----\r\n",code_list.CodeList[i]);
	
	memset(&code_list,0,sizeof(code_list));
	ZFY_LprProcess("/opt/car/a.jpg",&code_list);
	for(i=0;i<code_list.CodeNum;i++)
		printf("-----code=%s-----\r\n",code_list.CodeList[i]);
	memset(&code_list,0,sizeof(code_list));
	ZFY_LprProcess("/opt/car/b.jpg",&code_list);
	for(i=0;i<code_list.CodeNum;i++)
		printf("-----code=%s-----\r\n",code_list.CodeList[i]);
	memset(&code_list,0,sizeof(code_list));
	ZFY_LprProcess("/opt/car/c.jpg",&code_list);
	for(i=0;i<code_list.CodeNum;i++)
		printf("-----code=%s-----\r\n",code_list.CodeList[i]);
