...
#define LOG_EVENT_LOG_PRINTF_ENABLE			1
		...
		#define PRINTF(format,...)			ZFY_LES_LogPrintf(NULL,LOG_EVENT_LEVEL_DEF,format,##__VA_ARGS__)
...
#endif
#define LOGPRINTF(format,...)				ZFY_LES_LogPrintf(NULL,LOG_EVENT_LEVEL_DEF,format,##__VA_ARGS__)
...
#define LES_InitLogPath								ZFY_LES_InitLogPath
#define LES_NoPrintf								ZFY_LES_NoPrintf
#define LES_ConfigDebugServerAddr					ZFY_LES_ConfigDebugServerAddr
#define LES_UdpPrintf								ZFY_LES_UdpPrintf
#define LES_ConfigCallback							ZFY_LES_ConfigCallback
